...
#define DIGIPOT_MOTOR_CURRENT                                                                                \
    {                                                                                                        \
        ((950 - 750) / 5 + 135), ((950 - 750) / 5 + 135), ((1275 - 750) / 5 + 135), ((750 - 750) / 5 + 135), \
            ((750 - 750) / 5 + 135)                                                                          \
    }
...
#define DEFAULT_MINSEGMENTTIME 50000  // Default: 25000
#define SLOWDOWN
...
#define MAX_CMD_SIZE 128      // Default: 96
#define BUFSIZE 32            // Default: 4
#define TX_BUFFER_SIZE 256    // Default: 0
